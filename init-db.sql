...
ALTER TABLE `feedback`
  ADD FOREIGN KEY (`id_questionnaire`) REFERENCES `questionnaire`(`id`) ON DELETE CASCADE ON UPDATE CASCADE; 
ALTER TABLE `feedback`
  ADD FOREIGN KEY (`id_user`) REFERENCES `users`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
