...
$app->group('/questionnaires', function ($group) use ($questionnaireController) {
    ...
    $group->get('/{id:[0-9]+}/score/me', [$questionnaireController, 'getScore']); // Le score de l'utilisateur pour un questionnaire et les réponses qu'il a donné
    ...
    $group->post('/{id:[0-9]+}/feedback', [$questionnaireController, 'registerFeedback']); // Enregistrer le feedback d'un utilisateur pour un questionnaire
});
